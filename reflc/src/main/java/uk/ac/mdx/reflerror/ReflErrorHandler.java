...
public class ReflErrorHandler {
    ...
    public String reportError(final ReflError error) {
    ...
    public String generateErrorReport() {
        final StringBuilder sb = new StringBuilder();
        for (final ReflError err : errors) {
